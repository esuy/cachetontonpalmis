...
class BaseCoverFlowItemWrapper extends ViewGroup {
    ...
    public BaseCoverFlowItemWrapper(Context context) {
        super(context);
        this.init();
    }

    public BaseCoverFlowItemWrapper(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }

    public BaseCoverFlowItemWrapper(Context context, AttributeSet attrs, int defStyle) {
