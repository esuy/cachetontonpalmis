...
public abstract class BaseCoverFlowAdapter extends BaseAdapter {
    ...
    public final View getView(int i, View reusableView, ViewGroup viewGroup) {
        BaseCoverFlow coverFlow = (BaseCoverFlow) viewGroup;

        View wrappedView = null;
        BaseCoverFlowItemWrapper coverFlowItem;

        if (reusableView != null) {
            coverFlowItem = (BaseCoverFlowItemWrapper) reusableView;
            wrappedView = coverFlowItem.getChildAt(0);
            coverFlowItem.removeAllViews();
        } else {
            coverFlowItem = new BaseCoverFlowItemWrapper(viewGroup.getContext());
        }
